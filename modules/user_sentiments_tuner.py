"""Module for defining tuner function."""
...
def input_fn(file_pattern, tf_transform_output, num_epochs, batch_size=64):
    """Returns a dataset from TFRecord files for training."""
...
def model_builder(hp, vectorizer_layer):
    ...
    dense_units = hp.Int(
        "dense_units", min_value=64, max_value=512, step=64
    )
...
def tuner_fn(fn_args: FnArgs):
    """Defines the tuner function for hyperparameter tuning."""
